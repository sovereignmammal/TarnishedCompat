...
- **The Unknown** — stubs obsolete `WithCustomPool` so Codex pool calls don’t hang; the helper is **public** so The Codex can call it when rewards generate (fixes Lost Coffer hang).
